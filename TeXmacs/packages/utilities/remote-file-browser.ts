...
<\body>
  ...
  <assign|dir-entry|<\macro|icon-name|name|link|share-action>
    <concat|<dir-entry-icon|<arg|icon-name>|>|<hspace|1.5spc><hlink|<arg|name>|<arg|link>>|<htab|5mm>|<arg|share-action>>
  </macro>>
