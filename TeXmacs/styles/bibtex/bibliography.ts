...
<\body>
  ...
  <assign|bib-field-env|<\macro|ctype|cval|mvar|pre|type|val>
    <tabular|<tformat|<twith|table-width|1par>|<twith|table-hmode|min>|<cwith|1|-1|2|2|cell-halign|l>|<cwith|1|-1|2|2|cell-hyphen|t>|<cwith|1|-1|1|1|cell-width|10em>|<cwith|1|-1|1|1|cell-hmode|exact>|<cwith|1|-1|1|1|cell-lsep|1.5em>|<cwith|1|-1|2|2|cell-rsep|0em>|<table|<row|<cell|<with|color|<arg|ctype>|<arg|pre><strong|<arg|type>>>>|<\cell>
      <with|color|<arg|cval>|bib-var|<arg|mvar>|<arg|val>>
    </cell>>>>>
  </macro>>

  <assign|bib-field|<macro|type|val|<bib-field-env|dark
  ...
  <assign|bib-entry-env|<\macro|mfield|cfg|cbg|cid|pre|type|id|body>
    <\padded-normal|0.25em|1.5em>
      ...
      <with|bib-field|<arg|mfield>|<arg|body>>
    </padded-normal>
  </macro>>
  ...
  <assign|bib-entry|<\macro|type|id|body>
    ...
    blue|black|<macro|b|<with|color|dark green|<strong|<arg|b>>>>||<arg|t>|<arg|v>>>>
      ...
      green||<arg|type>|<arg|id>|<arg|body>>
    </with>
  </macro>>
  ...
  ><if|<unequal|<length|<arg|v>>|0>|<arg|><with|font-shape|italic|<arg|v>>
  ><with|font-shape|small-caps|<arg|l>><if|<unequal|<length|<arg|j>>|0>|,
  <arg|><with|font-shape|italic|<arg|j>> >>>

  <assign|bib-name-extra|<macro|x| <with|color|dark green|and> <arg|x>>>

  <assign|bib-names|<xmacro|args|<style-with|src-compact|none|<arg|args|0><map-args|bib-name-extra|concat|args|1>>>>

  <assign|bib-pages-extra|<macro|x|<with|color|dark green|--><arg|x>>>

  <assign|bib-pages|<xmacro|args|<style-with|src-compact|none|<arg|args|0><map-args|bib-pages-extra|concat|args|1>>>>

  <assign|keepcase|<macro|x|<with|color|dark green|{><arg|x><with|color|dark
  green|}>>>
</body>
