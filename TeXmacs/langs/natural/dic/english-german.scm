...
("reload" "wieder laden")
("remark" "Bemerkung")
("remove this switch" "entferne diesen Schalter")
...
("swedish" "schwedisch")
("switch" "Schalter")
("switch to first" "stelle um auf ersten")
("switch to formula style" "Formelstil benutzen")
("switch to last" "stelle um auf letzten")
("switch to next" "stelle um auf nächsten")
("switch to previous" "stelle um auf vorherigen")
