...
<\body>
  ...
  GNU <name|Octave> è un clone libero di <name|Matlab>, che può essere
  scaricato da
  ...
  La seconda parte mostra le capacità grafiche di Octave, grafici 2D e 3D. I
  grafici 2D possono essere inseriti automaticamente nel proprio foglio di
  lavoro, ma ciò non è possibile per i grafici 3D.
