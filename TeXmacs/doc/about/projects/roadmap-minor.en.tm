...
<\body>
  ...
  Even though our main focus is on the stabilization of <TeXmacs> and to make
  it more suitable for developers, we intend to continue some time on the
  ...
  <\itemize>
    ...
    chatting (with mathematical formulas) and collaborative authoring.

    <item>Development of universal spreadsheet tools, which can be connected
    to any external plug-in for doing the computations. In a similar vein,
    external plug-ins might be used to draw graphs of functions in the
    graphical mode.
  </itemize>
