...
<\body>
  ...
  <expand|big-table|<expand|descriptive-table|<tformat|<table|<row|<cell|Abbreviazione>|<cell|Scopo>|<cell|Esempio>>|<row|<cell|<key|'>>|<cell|Apici>|<cell|<with|mode|math|f<rprime|'>>
  o <with|mode|math|<with|mode|math|><with|mode|math|(g+h)<rprime|'''>>>>>|<row|<cell|<key|`>>|<cell|Apici
...
<\auxiliary>
  <\collection>
    <\associate|table>
      <tuple|normal|Creazione dei principali oggetti
      matematici.|<pageref|gly-1>>

      <tuple|normal|Creazione di apici, indici e indici posti in
      alto|<pageref|gly-2>>
    </associate>
  </collection>
</auxiliary>
