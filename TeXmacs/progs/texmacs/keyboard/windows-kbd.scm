...
(kbd-map
  ...
  ("windows r" (interactive replace-start-forward "Replace" "Replace by"))
...
(kbd-map
  ...
  ("windows:meta x" (interactive footer-eval "Command"))
  ...
  ("windows:copyto *" (interactive clipboard-copy "Copy to"))
  ...
  ("windows:cutto *" (interactive clipboard-cut "Cut to"))
  ...
  ("windows:pastefrom *" (interactive clipboard-paste "Paste from")))
