...
(tm-define (kbd-enter t forwards?)
  (:require (tree-in? t '(calc-comment)))
  (calc))

(tm-define (kbd-enter t forwards?)
  (:require (tree-in? t '(calc-input calc-output)))
  (alternate-toggle t))
