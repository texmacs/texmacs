...
(texmacs-module (math std-symbols))
...
(define-language std-symbols
  ...
  (Relation-nolim-symbol
   ...
   "<eqslantgtr>" "<eqslantless>" "<fallingdotseq>" "<geqq>" "<geqslant>" "<ggg>"
   "<gggtr>" "<gnapprox>" "<gneq>" "<gneqq>" "<gnsim>" "<gtrapprox>" "<gtrdot>"
   "<gtreqdot>" "<gtreqless>" "<gtreqqless>" "<gtrless>" "<gtrsim>" "<gvertneqq>"
   "<leqq>" "<leqslant>" "<lessapprox>" "<lessdot>" "<lesseqdot>" "<lesseqgtr>"
   "<lesseqqgtr>" "<lessgtr>" "<lesssim>" "<lll>" "<llless>" "<lnapprox>" "<lneq>"
   "<lneqq>" "<lnsim>" "<lvertneqq>" "<napprox>" "<ngeq>" "<ngeqq>" "<ngeqslant>"
   ...
   "<succcurlyeq>" "<nsucccurlyeq>" "<succnapprox>" "<succneqq>" "<succnsim>"
   "<succsim>" "<Supset>" "<supseteqq>" "<supsetneq>" "<thickapprox>" "<thicksim>"
  ...
  (Arrow-nolim-symbol
   ...
   "<leftrightarrow>" "<mapsto>" "<mapsfrom>" "<hookleftarrow>" "<hookrightarrow>"
   "<longleftarrow>" "<longrightarrow>" "<longleftrightarrow>" "<longmapsto>"
   "<longmapsfrom>" "<longhookleftarrow>" "<longhookrightarrow>" "<leftharpoonup>"
   ...
   "<circlearrowleft>" "<circlearrowdown>" "<curvearrowleft>" "<curvearrowright>"
