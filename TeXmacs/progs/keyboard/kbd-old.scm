...
(texmacs-module (keyboard kbd-old)
  (:use
    ...
    (texmacs edit edit-preamble) (texmacs edit edit-misc)
    (texmacs tools tm-select)))
...
(kbd-map
  ...
  ("emacs:meta f" (make-inactive-function))
  ("emacs:meta g" (make-group))
  ("emacs:meta m" (make-inactive-macro))
  ("emacs:meta p" (clipboard-paste "primary"))
  ("emacs:meta r" (clipboard-clear "primary"))
  ("emacs:meta v" (selection-move))
  ("emacs:meta w" (make-inactive-with))
  ("emacs:meta x" (clipboard-cut "primary"))
  ("emacs:meta =" (make-inactive-assign))
  ("emacs:meta *" (interactive '("Command:") 'footer-eval))
  ("emacs:meta [" (undo))
  ("emacs:meta ]" (redo))
  ("emacs:meta :" (make-format "line_break"))
  ("emacs:meta ;" (make-format "new_line"))
  ("emacs:meta return" (make-format "next_line"))
