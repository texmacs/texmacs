...
(kbd-map in-math?
  ...
  ("table N c" (make-expand-arg "choice"))
  ("table N m" (make-expand-arg "matrix"))
  ("table N d" (make-expand-arg "det"))
  ("table N s" (make-expand-arg "stack"))
