...
(kbd-map in-math?
  ...
  ("table N c" (make-compound-arg "choice"))
  ("table N m" (make-compound-arg "matrix"))
  ("table N d" (make-compound-arg "det"))
  ("table N s" (make-compound-arg "stack"))
