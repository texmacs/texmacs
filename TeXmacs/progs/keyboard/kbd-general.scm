...
(kbd-map
  ...
  ("space" (insert-string " "))
  ("return" (make-return))
  ("backspace" (general-remove-backwards))
  ("delete" (general-remove-forwards))
  ("tab" (general-tab))
  ("S-space" (insert-string " "))
  ("S-return" (make-shift-return))
  ("S-backspace" (general-remove-backwards))
  ("S-delete" (general-remove-forwards))
  ...
  ("A-backspace" (structured-remove-backwards))
  ("A-delete" (structured-remove-forwards))
  ("A-tab" (make-htab "5mm"))
