...
(define (build-font-cell fn kind)
  (cond ((string? kind) (build-with-font fn kind))
        ...
        ((unary? kind :ex) (numeric-distance fn kind "ex" 50.0))
        ((unary? kind :em) (numeric-distance fn kind "em" 100.0))
        ((unary? kind :lhw) (numeric-distance fn kind "lhw" 30.0))
        ((unary? kind :lvw) (numeric-distance fn kind "lvw" 20.0))
        ((unary? kind :uhw) (numeric-distance fn kind "uhw" 30.0))
        ((unary? kind :uvw) (numeric-distance fn kind "uvw" 20.0))
        ((unary? kind :fillp) (numeric-distance fn kind "fillp" 50.0))
        ((unary? kind :vcnt) (numeric-distance fn kind "vcnt" 50.0))
        ((unary? kind :lasprat) (numeric-distance fn kind "lasprat" 50.0))
        ((unary? kind :pasprat) (numeric-distance fn kind "pasprat" 50.0))
