...
(define (bibtex-latex x)
  (let ((options (acons "texmacs->latex:replace-style" "on" '())))
    (begin
      (set! options (acons "texmacs->latex:expand-macros" "on" options))
      (set! options (acons "texmacs->latex:expand-user-macros" "off" options))
      (set! options (acons "texmacs->latex:indirect-bib" "off" options))
      (set! options (acons "texmacs->latex:encoding" "ascii" options))
      (set! options (acons "texmacs->latex:use-macros" "off" options))
