...
(logic-table tmtex-tmstyle%
  ...
  (doc-title (,tmtex-doc-title -2))
  (doc-subtitle (,tmtex-doc-subtitle -2))
  (doc-note (,tmtex-doc-note -2))
  (doc-misc (,tmtex-doc-misc -2))
  (doc-date (,tmtex-doc-date -2))
  (doc-author (,tmtex-doc-author -2))
  (author-name (,tmtex-author-name -2))
  (author-affiliation (,tmtex-author-affiliation -2))
  (author-misc (,tmtex-author-misc -2))
  (author-note (,tmtex-author-note -2))
  (author-email (,tmtex-author-email -2))
  (author-homepage (,tmtex-author-homepage -2))
