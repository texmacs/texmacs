...
(drd-table tex-with-cmd%
  ...
  (("nr columns" "2") (!begin "multicols" "2"))
  (("nr columns" "3") (!begin "multicols" "3"))
  (("paragraph mode" "center") (!begin "center"))
  (("paragraph mode" "left") (!begin "flushleft"))
  (("paragraph mode" "right") (!begin "flushright")))
...
(drd-dispatcher tmtex-methods%
  ...
  (with_limits tmtex-noop)
  (line_break tmtex-line-break)
  (new_line tmtex-new-line)
  (line_separator tmtex-noop)
  (next_line tmtex-next-line)
  (no_break tmtex-noop)
  (no_first_indentation tmtex-no-first-indentation)
  (enable_first_indentation tmtex-noop)
  (no_indentation_after tmtex-noop)
  (enable_indentation_after tmtex-noop)
  (page_break_before tmtex-noop)
  (page_break tmtex-page-break)
  (no_page_break_before tmtex-noop)
  (no_page_break_after tmtex-noop)
  (new_page_before tmtex-noop)
  (new_page tmtex-new-page)
  (new_double_page_before tmtex-noop)
  (new_double_page tmtex-noop)
  (group tmtex-group)
  (left tmtex-left)
  (mid tmtex-mid)
  (right tmtex-right)
