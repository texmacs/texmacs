...
(tm-define (standard-focus-menu t)
  (gui$list
    ...
    (gui$optional (structured-vertical? t)
		  (gui$item ("Insert above" (structured-insert-up))))
    (gui$optional (structured-horizontal? t)
		  (gui$when (focus-can-insert)
			    (gui$item ("Insert argument before"
					(structured-insert #f)))))
    (gui$optional (structured-horizontal? t)
		  (gui$when (focus-can-insert)
			    (gui$item ("Insert argument after"
					(structured-insert #t)))))
    (gui$optional (structured-vertical? t)
		  (gui$item ("Insert below" (structured-insert-down))))
    (gui$optional (structured-vertical? t)
		  (gui$item ("Remove upwards" (structured-remove-up))))
    (gui$optional (structured-horizontal? t)
		  (gui$when (focus-can-remove)
			    (gui$item ("Remove argument before"
					(structured-remove #f)))))
    (gui$optional (structured-horizontal? t)
		  (gui$when (focus-can-remove)
			    (gui$item ("Remove argument after"
					(structured-remove #t)))))
    (gui$optional (structured-vertical? t)
		  (gui$item ("Remove downwards"
...
(tm-define (focus-variant-icons t)
  (gui$list
    ...
    (gui$optional (numbered-context? t)
      ;; FIXME: itemize, enumerate, eqnarray*
      (gui$item ((check (balloon (icon "tm_numbered.xpm")
				 "Toggle numbering")
			"v"
			(check-number? (focus-tree)))
		 (number-toggle (focus-tree)))))
    (gui$optional (toggle-context? t)
      (gui$item ((check (balloon (icon "tm_unfold.xpm")
				 "Fold / Unfold")
			"v"
			(toggle-second-context? (focus-tree)))
		 (toggle-toggle (focus-tree)))))
...
(tm-define (focus-insert-icons t)
  (gui$list
    (gui$optional (structured-vertical? t)
      (gui$item ((balloon (icon "tm_insert_up.xpm")
			  "Structured insert above")
		 (structured-insert-up))))
    (gui$optional (structured-horizontal? t)
      (gui$when (focus-can-insert)
		(gui$item ((balloon (icon "tm_insert_left.xpm")
				    "Structured insert at the left")
			   (structured-insert #f)))))
    (gui$optional (structured-horizontal? t)
      (gui$when (focus-can-insert)
		(gui$item ((balloon (icon "tm_insert_right.xpm")
				    "Structured insert at the right")
			   (structured-insert #t)))))
    (gui$optional (structured-vertical? t)
      (gui$item ((balloon (icon "tm_insert_down.xpm")
			  "Structured insert below")
		 (structured-insert-down))))
    (gui$optional (structured-vertical? t)
		  (gui$item ((balloon (icon "tm_delete_up.xpm")
				      "Structured remove upwards")
			     (structured-remove-up))))
    (gui$optional (structured-horizontal? t)
      (gui$when (focus-can-remove)
		(gui$item ((balloon (icon "tm_delete_left.xpm")
				    "Structured remove leftwards")
			   (structured-remove #f)))))
    (gui$optional (structured-horizontal? t)
      (gui$when (focus-can-remove)
		(gui$item ((balloon (icon "tm_delete_right.xpm")
				    "Structured remove rightwards")
			   (structured-remove #t)))))
    (gui$optional (structured-vertical? t)
      (gui$item ((balloon (icon "tm_delete_down.xpm")
