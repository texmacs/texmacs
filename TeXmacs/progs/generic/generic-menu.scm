...
(tm-define (focus-move-icons t)
  (list (list (list 'balloon (list 'icon "tm_similar_first.xpm")
	...
	(list (list 'balloon (list 'icon "tm_similar_previous.xpm")
		    "Go to previous similar tag")
	      (lambda () (traverse-previous)))
	(list (list 'balloon (list 'icon "tm_exit_left.xpm")
		    "Exit tag on the left")
	      (lambda () (structured-exit-left)))
	(list (list 'balloon (list 'icon "tm_exit_right.xpm")
		    "Exit tag on the right")
	      (lambda () (structured-exit-right)))
	(list (list 'balloon (list 'icon "tm_similar_next.xpm")
		    "Go to next similar tag")
	      (lambda () (traverse-next)))
	(list (list 'balloon (list 'icon "tm_similar_last.xpm")
		    "Go to last similar tag")
	      (lambda () (traverse-last)))))

(tm-define (focus-insert-icons t)
  (append (opt (structured-vertical? t)
