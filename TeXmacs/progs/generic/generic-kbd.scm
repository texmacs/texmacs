...
(kbd-map
  ...
  ("structured:geometry delete" (geometry-default (focus-tree)))
  ("structured:geometry backspace" (geometry-default (focus-tree)))
  ("structured:geometry left" (geometry-horizontal (focus-tree) #f))
  ("structured:geometry right" (geometry-horizontal (focus-tree) #t))
  ("structured:geometry up" (geometry-vertical (focus-tree) #f))
  ("structured:geometry down" (geometry-vertical (focus-tree) #t))
  ("structured:geometry home" (geometry-extremal (focus-tree) #f))
  ("structured:geometry end" (geometry-extremal (focus-tree) #t))
  ("structured:geometry pageup" (geometry-incremental (focus-tree) #f))
  ("structured:geometry pagedown" (geometry-incremental (focus-tree) #t))
  ("structured:geometry tab" (geometry-variant (focus-tree) #t))
  ("structured:geometry S-tab" (geometry-variant (focus-tree) #f))
...
(kbd-map
  ...
  ("emacs:meta [" (undo 0))
  ("emacs:meta ]" (redo 0))
  ("emacs:meta C-tab" (geometry-variant (focus-tree) #t))
  ("emacs:meta C-S-tab" (geometry-variant (focus-tree) #f))
