...
(kbd-map
  ...
  ("version |" (version-show-both))
  ("version left" (version-show-old))
  ("version right" (version-show-new))
...
(kbd-map
  ...
  ("C-|" (version-show-both))
  ("C-left" (version-show-old))
  ("C-right" (version-show-new))
  ("C-return" (version-retain-current))
  ("C-1" (version-retain-old))
  ("C-2" (version-retain-new)))
