...
(kbd-map
  ...
  ("| accent:grave" (math-bracket-open "lceil" "rceil" #t))
  ("| accent:grave var" (math-bracket-open "lceil" "rfloor" #t))
  ("accent:grave |" (math-bracket-close "rceil" "lceil" #t))
  ("| -" (math-bracket-open "|" "|" #t) (insert "-"))
  ("| =" (math-bracket-open "|" "|" #t) (insert "="))
  ("| | -" (math-bracket-open "||" "||" #t) (insert "-"))
  ("| | =" (math-bracket-open "||" "||" #t) (insert "="))
  ("| | | -" (math-bracket-open "<interleave>" "<interleave>" #t) (insert "-"))
  ("| | | =" (math-bracket-open "<interleave>" "<interleave>" #t) (insert "="))
