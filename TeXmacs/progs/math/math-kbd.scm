...
(kbd-map
  ...
  ("a n d" (make 'textual-and))
  ("a n d space" (make 'textual-and))
  ("space a n d" (make 'textual-and))
  ("space a n d space" (make 'textual-and))
  ("a n d var" "and")
  ("o r" (make 'textual-or))
  ("o r space" (make 'textual-or))
  ("space o r" (make 'textual-or))
  ("space o r space" (make 'textual-or))
  ("o r var" "or")
  ("i f f" (make 'textual-iff))
  ("i f f space" (make 'textual-iff))
  ("space i f f" (make 'textual-iff))
  ("space i f f space" (make 'textual-iff))
  ("i f f var" "iff")
  ("f o r space a l l" (make 'textual-for-all))
  ("f o r space a l l space" (make 'textual-for-all)))

(kbd-map
  (:mode in-math-dutch?)
  ("e n" (make 'textual-and))
  ("e n space" (make 'textual-and))
  ("space e n" (make 'textual-and))
  ("space e n space" (make 'textual-and))
  ("e n var" "en")
  ("of" (make 'textual-or))
  ("of space" (make 'textual-or))
  ("space of" (make 'textual-or))
  ("space of space" (make 'textual-or))
  ("of var" "of")
  ("d e s d a" (make 'textual-iff))
  ("d e s d a space" (make 'textual-iff))
  ("space d e s d a" (make 'textual-iff))
  ("space d e s d a space" (make 'textual-iff))
  ("d e s d a var" "desda")
  ("v o o r space a l l e" (make 'textual-for-all))
  ("v o o r space a l l e space" (make 'textual-for-all)))

(kbd-map
  (:mode in-math-french?)
  ("e t" (make 'textual-and))
  ("e t space" (make 'textual-and))
  ("space e t" (make 'textual-and))
  ("space e t space" (make 'textual-and))
  ("e t var" "et")
  ("o u" (make 'textual-or))
  ("o u space" (make 'textual-or))
  ("space o u" (make 'textual-or))
  ("space o u space" (make 'textual-or))
  ("o u var" "ou")
  ("s s i" (make 'textual-iff))
  ("s s i space" (make 'textual-iff))
  ("space s s i" (make 'textual-iff))
  ("space s s i space" (make 'textual-iff))
  ("s s i var" "ssi")
  ("p o u r space t o u t" (make 'textual-for-all))
  ("p o u r space t o u t space" (make 'textual-for-all)))

(kbd-map
  (:mode in-math-german?)
  ("u n d" (make 'textual-and))
  ("u n d space" (make 'textual-and))
  ("space u n d" (make 'textual-and))
  ("space u n d space" (make 'textual-and))
  ("u n d var" "und")
  ("o d e r" (make 'textual-or))
  ("o d e r space" (make 'textual-or))
  ("space o d e r" (make 'textual-or))
  ("space o d e r space" (make 'textual-or))
  ("o d e r var" "oder")
  ("g d w" (make 'textual-iff))
  ("g d w space" (make 'textual-iff))
  ("space g d w" (make 'textual-iff))
  ("space g d w space" (make 'textual-iff))
  ("g d w var" "gdw")
  ("f u r space a l l e" (make 'textual-for-all))
  ("f u r space a l l e space" (make 'textual-for-all))
  ("f u e r space a l l e" (make 'textual-for-all))
  ("f u e r space a l l e space" (make 'textual-for-all)))
