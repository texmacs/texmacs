...
(kbd-map
  ...
  (", var var space space" (insert '(separating-space "1em")))
  (", var var space space space" (insert '(separating-space "2em")))
  (", space" ",")
  (", space var" (insert '(separating-space "0.2em")))
  (", space space" (insert ",") (make-space "1em"))
  (", space space var" (insert '(separating-space "1em")))
  (", space space space" (insert ",") (make-space "2em"))
  (", space space space var" (insert '(separating-space "2em")))
  (", ," ",<ldots>,")
  ("; ;" ";<ldots>;")
  ("." ".")
  (". var" "<point>")
  ...
  ("math:symbol I var" (math-big-operator "intlim"))
  ...
  ("math:symbol O var" (math-big-operator "ointlim"))
  ...
  ("- /" "<rightharpoondown>")
  ("- / var" "<rightharpoonup>")
  ("- / var var" "<downharpoonleft>")
  ("- / var var var" "<downharpoonright>")
  ("- / var var var var" "<upharpoonright>")
  ("- / var var var var var" "<upharpoonleft>")
  ("/ -" "<leftharpoonup>")
  ("/ - var" "<leftharpoondown>")
  ("/ - var var" "<upharpoonright>")
  ("/ - var var var" "<upharpoonleft>")
  ("/ - var var var var" "<downharpoonleft>")
  ("/ - var var var var var" "<downharpoonright>")
  ("| - >" "<mapsto>")
  ("| - > var" "<hookrightarrow>")
  ("| - > var var" "<mapsdown>")
