...
;; (tm-define graphical-arrow-begin "default")
;; (tm-define graphical-arrow-end "default")
;; (tm-define graphical-arrow-length "default")
;; (tm-define graphical-arrow-height "default")
...
;;   (set! graphical-arrow-begin (find-prop o "arrow-begin" "default"))
;;   (set! graphical-arrow-end (find-prop o "arrow-end" "default"))
;;   (set! graphical-arrow-length (find-prop o "arrow-length" "default"))
;;   (set! graphical-arrow-height (find-prop o "arrow-height" "default"))
...
(tm-define (create-graphical-props mode ps0)
  (let ((op #f)
	...
	(va #f)
     ...
     (cond
	((== mode 'active)
         (set! op (ahash-ref graphical-attrs "opacity"))
         (set! color (ahash-ref graphical-attrs "color"))
         (set! ps (ahash-ref graphical-attrs "point-style"))
         (set! lw (ahash-ref graphical-attrs "line-width"))
         (set! mag (ahash-ref graphical-attrs "magnification"))
         (set! st (ahash-ref graphical-attrs "dash-style"))
         (set! stu (ahash-ref graphical-attrs "dash-style-unit"))
         (set! a1 (ahash-ref graphical-attrs "arrow-begin"))
         (set! a2 (ahash-ref graphical-attrs "arrow-end"))
         (set! a3 (ahash-ref graphical-attrs "arrow-length"))
         (set! a4 (ahash-ref graphical-attrs "arrow-height"))
         (set! fc (ahash-ref graphical-attrs "fill-color"))
         (set! ha (ahash-ref graphical-attrs "text-at-halign"))
         (set! va (ahash-ref graphical-attrs "text-at-valign")))
...
;; 	 (set! a1 graphical-arrow-begin)
;; 	 (set! a2 graphical-arrow-end)
;; 	 (set! a3 graphical-arrow-length)
;; 	 (set! a4 graphical-arrow-height)
...
;; 	 (set! va graphical-textat-valign))
	((list? mode)
	 ...
	 (set! a1 (graphics-path-property mode "arrow-begin"))
	 (set! a2 (graphics-path-property mode "arrow-end"))
	 (set! a3 (graphics-path-property mode "arrow-length"))
	 (set! a4 (graphics-path-property mode "arrow-height"))
	...
	((== mode 'new)
	 ...
	 (set! a1 (graphics-get-property "arrow-begin"))
	 (set! a2 (graphics-get-property "arrow-end"))
	 (set! a3 (graphics-get-property "arrow-length"))
	 (set! a4 (graphics-get-property "arrow-height"))
	...
	((== mode 'default)
	 ...
	 (set! a1 (get-default-val "arrow-begin"))
	 (set! a2 (get-default-val "arrow-end"))
	 (set! a3 (get-default-val "arrow-length"))
	 (set! a4 (get-default-val "arrow-height"))
     ...
     (list 'with "point-style"
		 ...
		 "arrow-begin" (dv "arrow-begin" a1)
		 "arrow-end" (dv "arrow-end" a2)
		 "arrow-length" (dv "arrow-length" a3)
		 "arrow-height" (dv "arrow-height" a4)
