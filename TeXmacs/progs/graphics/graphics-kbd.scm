...
(kbd-map
  ...
  ("S-A-left" (graphics-change-extents "-1cm" "0cm"))
  ("S-A-right" (graphics-change-extents "+1cm" "0cm"))
  ("S-A-down" (graphics-change-extents "0cm" "+1cm"))
  ("S-A-up" (graphics-change-extents "0cm" "-1cm"))
