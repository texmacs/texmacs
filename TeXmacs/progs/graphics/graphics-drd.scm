...
(tm-define (ahash-table->properties t)
  (list (ahash-ref t "opacity")
        (ahash-ref t "color")
        (ahash-ref t "point-style")
        (ahash-ref t "line-width")
        (ahash-ref t "magnification")
        (ahash-ref t "dash-style")
        (ahash-ref t "dash-style-unit")
        (ahash-ref t "arrow-begin")
        (ahash-ref t "arrow-end")
        (ahash-ref t "arrow-length")
        (ahash-ref t "arrow-height")
        (ahash-ref t "fill-color")
        (ahash-ref t "text-at-halign")
        (ahash-ref t "text-at-valign")))

(tm-define (properties->ahash-table l)
  (with (op col ps lw mag ds dsu a1 a2 a3 a4 fc hal val) l
    (with t (make-ahash-table)
      (ahash-set! t "opacity" op)
      (ahash-set! t "color" col)
      (ahash-set! t "point-style" ps)
      (ahash-set! t "line-width" lw)
      (ahash-set! t "magnification" mag)
      (ahash-set! t "dash-style" ds)
      (ahash-set! t "dash-style-unit" dsu)
      (ahash-set! t "arrow-begin" a1)
      (ahash-set! t "arrow-end" a2)
      (ahash-set! t "arrow-length" a3)
      (ahash-set! t "arrow-height" a4)
      (ahash-set! t "fill-color" fc)
      (ahash-set! t "text-at-halign" hal)
      (ahash-set! t "text-at-valign" val)
      t)))
