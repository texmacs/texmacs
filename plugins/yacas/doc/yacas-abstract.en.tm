...
<\body>
  <tmdoc-title|The <name|Yacas> system>

  <hlink|<name|Yacas>|http://www.yacas.org> is, as it's name suggest, yet
  ...
  polynomials, integrating functions and tensor calculations. <name|Yacas> is
