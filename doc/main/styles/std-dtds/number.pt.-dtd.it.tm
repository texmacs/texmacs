...
<\body>
  <expand|tmdoc-title|Ambienti di numerazione>

  Il <abbr|d.t.d.> <tmdtd|number-env> fornisce tag di basso livello per la
  ...
  d'ambiente. Questo solitamente viene compiuto all'inizio di ciascun
