...
<\body>
  <tmdoc-title|Escribiendo su primer texto con <TeXmacs>>

  <\traverse>
    <branch|Después de iniciar|tut-afterstart.es.tm>

    <branch|Dando un nombre a su documento|tut-givename.es.tm>

    <branch|Escribiendo un texto sencillo|tut-firsttext.es.tm>
  </traverse>
