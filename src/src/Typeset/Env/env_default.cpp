...
initialize_default_env () {
  ...
  env (GR_UNIT)          = "1cm";       // graphical unit
  env (GR_CLIP_LEFT)     = "0cm";       // left clipping
  env (GR_CLIP_BOTTOM)   = "0cm";       // bottom clipping
  env (GR_CLIP_RIGHT)    = "0cm";       // left clipping
  env (GR_CLIP_TOP)      = "0cm";       // top clipping
