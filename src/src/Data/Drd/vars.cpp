...
string LINE_PATTERN_MODE ("line-pattern-mode");
string LINE_PATTERN ("line-pattern");
...
string GR_LINE_PATTERN_MODE ("gr-line-pattern-mode");
string GR_LINE_PATTERN ("gr-line-pattern");
