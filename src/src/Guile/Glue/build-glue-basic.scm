...
(build
  ...
  (tmfs-get-solutions tmfs_get_solutions (solutions array_string))
  (tmfs-get-solutions2 tmfs_get_solutions (solutions solutions array_string))
  (tmfs-get-values tmfs_get_values (collection array_string))
  (tmfs-get-values2 tmfs_get_values (collection solutions array_string))
  ...
  (tmfs-get-permissions tmfs_get_permissions (collection string string))
  (tmfs-set-permissions tmfs_set_permissions (void string string collection))
  (tmfs-set-all-permissions tmfs_set_permissions (void string collection))
  (tmfs-create-file tmfs_create_file (string string string))
  (tmfs-create-file2 tmfs_create_similar_file (string string string string))
  (tmfs-search-file tmfs_search_file (collection string))
  (tmfs-search-head tmfs_search_head (collection string))
  (tmfs-update-file tmfs_update_file (string string string))
  ...
  (tmfs-create-snapshot tmfs_create_snapshot (string string string))
  (tmfs-search-snapshot tmfs_search_snapshot (collection string))
  (tmfs-get-heads tmfs_get_heads (collection string))
  (tmfs-branch-file tmfs_branch_file (void string string))
  (tmfs-branch-project tmfs_branch_project (void string string))
