...
(build
  ...
  (tree0 tree (tree tree_label))
  (tree1 tree (tree tree_label tree))
  (tree2 tree (tree tree_label tree tree))
  (tree3 tree (tree tree_label tree tree tree))
  (tree-ip obtain_ip (path tree))
  (tree-atomic? is_atomic (bool tree))
  (tree-compound? is_compound (bool tree))
  (tree-arity N (int tree))
  (tree-ref tree_ref (tree tree int))
  (tree-set! tree_set (void tree int tree))
