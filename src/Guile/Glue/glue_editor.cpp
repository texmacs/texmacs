...
initialize_glue_editor () {
  ...
  scm_new_procedure ("make-session", (FN) tmg_make_session, 2, 0, 0);
  scm_new_procedure ("start-input", (FN) tmg_start_input, 3, 0, 0);
  scm_new_procedure ("process-input", (FN) tmg_process_input, 0, 0, 0);
  scm_new_procedure ("session-use-math-input", (FN) tmg_session_use_math_input, 1, 0, 0);
  scm_new_procedure ("session-math-input?", (FN) tmg_session_math_inputP, 0, 0, 0);
  scm_new_procedure ("session-go-up", (FN) tmg_session_go_up, 0, 0, 0);
  scm_new_procedure ("session-go-down", (FN) tmg_session_go_down, 0, 0, 0);
  scm_new_procedure ("session-go-page-up", (FN) tmg_session_go_page_up, 0, 0, 0);
  scm_new_procedure ("session-go-page-down", (FN) tmg_session_go_page_down, 0, 0, 0);
  scm_new_procedure ("session-remove", (FN) tmg_session_remove, 1, 0, 0);
  scm_new_procedure ("session-insert-text-field", (FN) tmg_session_insert_text_field, 0, 0, 0);
  scm_new_procedure ("session-insert-input-above", (FN) tmg_session_insert_input_above, 0, 0, 0);
  scm_new_procedure ("session-insert-input-below", (FN) tmg_session_insert_input_below, 0, 0, 0);
  scm_new_procedure ("session-fold-input", (FN) tmg_session_fold_input, 0, 0, 0);
  scm_new_procedure ("session-remove-input", (FN) tmg_session_remove_input, 1, 0, 0);
