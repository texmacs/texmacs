...
(build
  ...
  (inside-go-up session_go_up (void string))
  (inside-go-down session_go_down (void string))
  (inside-go-left session_go_left (void string))
  (inside-go-right session_go_right (void string))
