...
enum tree_label {
  ...
  EFF_MOVE, EFF_MAGNIFY, EFF_BUBBLE,
  EFF_GAUSSIAN, EFF_OVAL, EFF_RECTANGULAR,
  EFF_BLUR, EFF_OUTLINE, EFF_THICKEN,
  EFF_SUPERPOSE, EFF_MUL, EFF_MIN, EFF_MAX, EFF_MIX,
  EFF_SET_COLOR, EFF_MAKE_TRANSPARENT, EFF_MAKE_OPAQUE,
