...
(build
  ...
  (base-color base_color  (int string))
  (x11-color x11_color   (int string))
  (dvips-color dvips_color (int string))
  (html-color html_color  (int string))
  (get-named-color get_named_color (string int))
