...
wk_widget text_wk_widget (string s, bool tsp= false);
...
wk_widget input_text_wk_widget (command call_back, string width= "1w");
wk_widget input_text_wk_widget (command call_back, string type,
