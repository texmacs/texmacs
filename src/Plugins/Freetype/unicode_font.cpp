...
unicode_font_rep::script_adjust_stix () {
  ...
  rsub_adjust_char ("<gamma>", -0.05);
  rsub_adjust_char ("<b-up-gamma>", -0.05);
  rsub_adjust_char ("<sigma>", -0.03);
  rsub_adjust_char ("<b-up-sigma>", -0.03);
  rsub_adjust_char ("<tau>", -0.03);
  rsub_adjust_char ("<b-up-tau>", -0.03);
  rsub_adjust_char ("<varpi>", -0.05);
  rsub_adjust_char ("<b-up-varpi>", -0.05);
...
void
unicode_font_rep::script_adjust_termes () {
  rsub_adjust_pair ("!", 0.05);
  rsub_adjust_pair ("/", -0.02);
  ...
  rsub_adjust_pair ("G", 0.03);
  rsub_adjust_pair ("I", 0.03);
  rsub_adjust_pair ("J", 0.02);
  rsub_adjust_pair ("N", -0.02);
  rsub_adjust_pair ("O", 0.01);
  rsub_adjust_pair ("P", -0.02);
  rsub_adjust_pair ("Q", 0.02);
  rsub_adjust_pair ("R", 0.02);
  rsub_adjust_pair ("S", 0.03);
  rsub_adjust_pair ("T", -0.02);
  rsub_adjust_pair ("U", -0.02);
  rsub_adjust_pair ("Z", 0.05);
  for (char c= 'a'; c <= 'z'; c++)
    rsub_adjust_pair (string (c), 0.02);
  rsub_adjust_pair ("h", 0.02);
  rsub_adjust_pair ("l", 0.02);
  rsub_adjust_pair ("m", 0.02);
  rsub_adjust_pair ("n", 0.01);
  rsub_adjust_pair ("x", 0.02);
  rsub_adjust_pair ("z", 0.02);
  rsub_adjust_pair ("<Alpha>", 0.02);
  rsub_adjust_pair ("<Delta>", 0.01);
  rsub_adjust_pair ("<Gamma>", -0.02);
  rsub_adjust_pair ("<Theta>", -0.02);
  ...
  rsub_adjust_pair ("<Kappa>", 0.02);
  rsub_adjust_pair ("<Lambda>", 0.02);
  rsub_adjust_pair ("<Nu>", -0.02);
  rsub_adjust_pair ("<Omicron>", -0.02);
  rsub_adjust_pair ("<Pi>", 0.02);
  rsub_adjust_pair ("<Rho>", -0.02);
  rsub_adjust_pair ("<Tau>", -0.02);
  rsub_adjust_pair ("<Upsilon>", -0.05);
  rsub_adjust_pair ("<Chi>", 0.02);
  rsub_adjust_pair ("<Backepsilon>", 0.05);
  rsub_adjust_char ("<#1D6FC>", -0.03);
  rsub_adjust_char ("<b-alpha>", -0.03);
  rsub_adjust_char ("<#1D6FD>", -0.03);
  rsub_adjust_char ("<b-beta>", -0.03);
  rsub_adjust_char ("<#1D6FE>", -0.1);
  rsub_adjust_char ("<b-gamma>", -0.1);
  rsub_adjust_char ("<#1D701>", -0.05);
  rsub_adjust_char ("<b-zeta>", -0.05);
  rsub_adjust_char ("<#1D703>", -0.02);
  rsub_adjust_char ("<b-theta>", -0.02);
  rsub_adjust_char ("<#1D706>", -0.02);
  rsub_adjust_char ("<b-kappa>", -0.02);
  rsub_adjust_char ("<#1D708>", -0.05);
  rsub_adjust_char ("<b-nu>", -0.05);
  rsub_adjust_char ("<#1D709>", -0.05);
  rsub_adjust_char ("<b-xi>", -0.05);
  rsub_adjust_char ("<#1D70B>", -0.03);
  rsub_adjust_char ("<b-pi>", -0.03);
  rsup_adjust_char ("<#1D70C>", -0.03);
  rsup_adjust_char ("<b-rho>", -0.03);
  rsup_adjust_char ("<#1D70E>", -0.07);
  rsup_adjust_char ("<b-sigma>", -0.07);
  rsup_adjust_char ("<#1D70F>", -0.07);
  rsup_adjust_char ("<b-tau>", -0.07);
  rsub_adjust_char ("<#1D712>", -0.07);
  rsub_adjust_char ("<b-chi>", -0.07);
  rsub_adjust_char ("<#1D713>", -0.07);
  rsub_adjust_char ("<b-psi>", -0.07);
  rsub_adjust_char ("<#1D714>", -0.02);
  rsub_adjust_char ("<b-omega>", -0.02);
  rsub_adjust_char ("<#1D716>", -0.05);
  rsub_adjust_char ("<b-varepsilon>", -0.05);
  rsub_adjust_char ("<#1D71B>", -0.08);
  rsub_adjust_char ("<b-varpi>", -0.08);
  rsub_adjust_char ("<gamma>", -0.03);
  rsub_adjust_char ("<b-up-gamma>", -0.03);
  rsub_adjust_char ("<psi>", -0.05);
  rsub_adjust_char ("<b-up-psi>", -0.05);
  rsub_adjust_pair ("<cal-A>", 0.03);
  rsub_adjust_pair ("<cal-C>", -0.1);
  rsub_adjust_pair ("<cal-F>", -0.2);
  rsub_adjust_pair ("<cal-G>", -0.1);
  rsub_adjust_pair ("<cal-H>", 0.05);
  rsub_adjust_pair ("<cal-I>", -0.12);
  rsub_adjust_pair ("<cal-J>", -0.05);
  rsub_adjust_pair ("<cal-K>", -0.05);
  rsub_adjust_pair ("<cal-M>", 0.03);
  rsub_adjust_pair ("<cal-N>", -0.3);
  rsub_adjust_pair ("<cal-P>", -0.03);
  rsub_adjust_pair ("<cal-S>", -0.1);
  rsub_adjust_pair ("<cal-T>", -0.3);
  rsub_adjust_pair ("<cal-V>", -0.3);
  rsub_adjust_pair ("<cal-W>", -0.3);
  rsub_adjust_pair ("<cal-X>", -0.1);
  rsub_adjust_pair ("<cal-Y>", -0.05);
  rsub_adjust_pair ("<cal-a>", -0.05);
  rsub_adjust_pair ("<cal-c>", -0.02);
  rsub_adjust_pair ("<cal-d>", -0.08);
  rsub_adjust_pair ("<cal-e>", -0.03);
  rsub_adjust_pair ("<cal-f>", -0.12);
  rsub_adjust_pair ("<cal-g>", -0.05);
  rsub_adjust_pair ("<cal-h>", -0.05);
  rsub_adjust_pair ("<cal-i>", -0.03);
  rsub_adjust_pair ("<cal-j>", -0.05);
  ...
  rsub_adjust_pair ("<cal-p>", -0.03);
  rsub_adjust_pair ("<cal-q>", -0.02);
  rsub_adjust_pair ("<cal-t>", -0.03);
  rsub_adjust_pair ("<cal-x>", -0.02);
  rsub_adjust_pair ("<cal-y>", -0.02);
  rsub_adjust_pair ("<cal-z>", -0.05);
  rsub_adjust_pair ("<bbb-A>", -0.03);
  rsub_adjust_pair ("<bbb-D>", -0.02);
  rsub_adjust_pair ("<bbb-F>", -0.07);
  rsub_adjust_pair ("<bbb-H>", 0.02);
  rsub_adjust_pair ("<bbb-I>", 0.03);
  rsub_adjust_pair ("<bbb-M>", 0.02);
  rsub_adjust_pair ("<bbb-P>", -0.03);
  rsub_adjust_pair ("<bbb-Q>", 0.05);
  rsub_adjust_pair ("<bbb-S>", 0.03);
  rsub_adjust_pair ("<bbb-T>", -0.05);
  rsub_adjust_pair ("<bbb-U>", -0.05);
  rsub_adjust_pair ("<bbb-V>", -0.12);
  rsub_adjust_pair ("<bbb-W>", -0.12);
  ...
  rsup_adjust_pair ("?", 0.05);
  rsup_adjust_pair ("/", 0.05);
  rsup_adjust_pair ("0", 0.03);
  rsup_adjust_pair ("B", 0.03);
  rsup_adjust_pair ("D", 0.02);
  rsup_adjust_pair ("G", 0.02);
  ...
  rsup_adjust_pair ("t", 0.02);
  rsup_adjust_pair ("x", 0.02);
  rsup_adjust_pair ("<Alpha>", -0.05);
  rsup_adjust_pair ("<Gamma>", 0.02);
  rsup_adjust_pair ("<Delta>", -0.02);
  rsup_adjust_pair ("<Epsilon>", -0.02);
  rsup_adjust_pair ("<Lambda>", -0.05);
  rsup_adjust_pair ("<Rho>", 0.02);
  rsup_adjust_pair ("<Phi>", 0.02);
  rsup_adjust_pair ("<Psi>", 0.01);
  rsup_adjust_pair ("<Tau>", 0.02);
  ...
  rsup_adjust_char ("<#1D6FD>", 0.02);
  rsup_adjust_char ("<b-beta>", 0.02);
  rsup_adjust_char ("<#1D701>", 0.03);
  rsup_adjust_char ("<b-zeta>", 0.03);
  rsup_adjust_char ("<#1D703>", 0.03);
  rsup_adjust_char ("<b-theta>", 0.03);
  rsup_adjust_char ("<#1D709>", 0.03);
  rsup_adjust_char ("<b-xi>", 0.03);
  rsup_adjust_char ("<#1D70D>", 0.02);
  rsup_adjust_char ("<b-varsigma>", 0.02);
  rsup_adjust_pair ("<mho>", 0.02);
  rsup_adjust_char ("<beta>", -0.03);
  rsup_adjust_char ("<b-up-beta>", -0.03);
  rsup_adjust_char ("<zeta>", -0.05);
  rsup_adjust_char ("<b-up-zeta>", -0.05);
  rsup_adjust_char ("<eta>", -0.03);
  rsup_adjust_char ("<b-up-eta>", -0.03);
  rsup_adjust_char ("<theta>", -0.03);
  rsup_adjust_char ("<b-up-theta>", -0.03);
  rsup_adjust_char ("<iota>", -0.05);
  rsup_adjust_char ("<b-up-iota>", -0.05);
  rsup_adjust_char ("<lambda>", -0.17);
  rsup_adjust_char ("<b-up-lambda>", -0.17);
  rsup_adjust_char ("<mu>", -0.07);
  rsup_adjust_char ("<b-up-mu>", -0.07);
  rsup_adjust_char ("<xi>", -0.01);
  rsup_adjust_char ("<b-up-xi>", -0.01);
  rsup_adjust_char ("<omicron>", -0.03);
  rsup_adjust_char ("<b-up-omicron>", -0.03);
  rsup_adjust_char ("<psi>", -0.02);
  rsup_adjust_char ("<b-up-psi>", -0.02);
  rsup_adjust_char ("<chi>", -0.05);
  rsup_adjust_char ("<b-up-chi>", -0.05);
  rsup_adjust_char ("<omega>", -0.03);
  rsup_adjust_char ("<b-up-omega>", -0.03);
  rsup_adjust_char ("<varepsilon>", -0.03);
  rsup_adjust_char ("<b-up-varepsilon>", -0.03);
  rsup_adjust_char ("<vartheta>", -0.02);
  rsup_adjust_char ("<b-up-vartheta>", -0.02);
  rsup_adjust_pair ("<cal-I>", -0.03);
  rsup_adjust_pair ("<bbb-A>", -0.05);
  rsup_adjust_pair ("<bbb-D>", 0.02);
  rsup_adjust_pair ("<bbb-H>", 0.02);
  rsup_adjust_pair ("<bbb-J>", 0.01);
  rsup_adjust_pair ("<bbb-K>", -0.03);
  rsup_adjust_pair ("<bbb-L>", -0.05);
  rsup_adjust_pair ("<bbb-M>", 0.01);
  rsup_adjust_pair ("<bbb-P>", 0.02);
  rsup_adjust_pair ("<bbb-R>", -0.03);
  rsup_adjust_pair ("<frak-Q>", -0.02);
  rsup_adjust_pair ("<frak-U>", -0.03);
  rsup_adjust_pair ("<frak-a>", -0.03);
  rsup_adjust_pair ("<frak-b>", -0.01);
  rsup_adjust_pair ("<frak-i>", -0.02);
  rsup_adjust_pair ("<frak-j>", 0.01);
  rsup_adjust_pair ("<frak-l>", -0.01);
  rsup_adjust_pair ("<frak-p>", -0.01);
  rsup_adjust_pair ("<frak-u>", -0.03);
  rsup_adjust_pair ("<frak-v>", -0.02);
  rsup_adjust_pair ("<frak-w>", -0.02);
  rsup_adjust_pair ("<frak-y>", -0.01);
}
...
unicode_font_rep::script_adjust_pagella () {
  ...
  rsub_adjust_char ("<sigma>", -0.08);
  rsub_adjust_char ("<b-up-sigma>", -0.08);
  rsub_adjust_char ("<varpi>", -0.02);
  rsub_adjust_char ("<b-up-varpi>", -0.02);
  for (char c= 'A'; c <= 'Z'; c++)
  ...
  rsup_adjust_char ("<alpha>", -0.02);
  rsup_adjust_char ("<b-up-alpha>", -0.02);
  rsup_adjust_char ("<gamma>", 0.03);
  rsup_adjust_char ("<b-up-gamma>", 0.03);
  rsup_adjust_char ("<kappa>", -0.02);
  rsup_adjust_char ("<b-up-kappa>", -0.02);
  rsup_adjust_char ("<lambda>", -0.1);
  rsup_adjust_char ("<b-up-lambda>", -0.1);
  rsup_adjust_char ("<mu>", -0.05);
  rsup_adjust_char ("<b-up-mu>", -0.05);
  rsup_adjust_char ("<vartheta>", 0.03);
  rsup_adjust_char ("<b-up-vartheta>", 0.03);
  for (char c= 'A'; c <= 'Z'; c++)
...
unicode_font_rep::script_adjust_schola () {
  ...
  rsup_adjust_pair ("$", 0.05);
  rsup_adjust_pair ("?", 0.05);
  rsup_adjust_pair ("0", 0.05);
  rsup_adjust_pair ("2", 0.03);
  rsup_adjust_pair ("9", 0.05);
  rsub_adjust_pair ("\\", -0.05);
  rsub_adjust_pair ("|", 0.05);
  rsup_adjust_pair ("A", -0.05);
  rsup_adjust_pair ("C", 0.03);
  rsup_adjust_pair ("D", 0.02);
  rsup_adjust_pair ("G", 0.02);
  rsup_adjust_pair ("J", 0.02);
  rsup_adjust_pair ("M", 0.03);
  rsup_adjust_pair ("P", 0.03);
  rsup_adjust_pair ("Q", 0.02);
  rsup_adjust_pair ("V", 0.02);
  rsup_adjust_pair ("X", 0.01);
  rsup_adjust_pair ("Y", 0.01);
  rsup_adjust_pair ("Z", 0.03);
  rsup_adjust_pair ("f", 0.02);
  rsup_adjust_pair ("g", 0.03);
  rsup_adjust_pair ("h", -0.03);
  rsup_adjust_pair ("i", 0.02);
  rsup_adjust_pair ("j", 0.03);
  rsup_adjust_pair ("l", 0.03);
  rsup_adjust_pair ("m", -0.02);
  rsup_adjust_pair ("n", -0.02);
  rsup_adjust_pair ("o", 0.01);
  rsup_adjust_pair ("q", 0.02);
  rsup_adjust_pair ("r", 0.03);
  rsup_adjust_pair ("s", 0.02);
  rsup_adjust_pair ("t", 0.02);
  rsup_adjust_pair ("x", 0.01);
  rsup_adjust_pair ("y", 0.01);
  rsup_adjust_pair ("z", 0.01);
  rsup_adjust_char ("<b-A>", 0.02);
  rsup_adjust_char ("<b-L>", 0.02);
  rsup_adjust_pair ("<Alpha>", -0.05);
  rsup_adjust_pair ("<Delta>", -0.03);
  rsup_adjust_pair ("<Iota>", 0.01);
  rsup_adjust_pair ("<Lambda>", -0.04);
  rsup_adjust_pair ("<Xi>", 0.01);
  rsup_adjust_char ("<#1D6FE>", 0.04);
  rsup_adjust_char ("<b-gamma>", 0.04);
  rsup_adjust_char ("<#1D6FF>", 0.04);
  rsup_adjust_char ("<b-delta>", 0.04);
  rsup_adjust_char ("<#1D700>", 0.03);
  rsup_adjust_char ("<b-epsilon>", 0.03);
  rsup_adjust_char ("<#1D703>", 0.05);
  rsup_adjust_char ("<b-theta>", 0.05);
  rsup_adjust_char ("<#1D704>", -0.02);
  rsup_adjust_char ("<b-iota>", -0.02);
  rsup_adjust_char ("<#1D706>", -0.12);
  rsup_adjust_char ("<b-lambda>", -0.12);
  rsup_adjust_char ("<#1D707>", -0.06);
  rsup_adjust_char ("<b-mu>", -0.06);
  rsup_adjust_char ("<#1D70B>", 0.03);
  rsup_adjust_char ("<b-pi>", 0.03);
  rsup_adjust_char ("<#1D70D>", 0.02);
  rsup_adjust_char ("<b-varsigma>", 0.02);
  rsup_adjust_char ("<#1D70E>", 0.02);
  rsup_adjust_char ("<b-sigma>", 0.02);
  rsup_adjust_char ("<#1D70F>", 0.04);
  rsup_adjust_char ("<b-tau>", 0.04);
  rsup_adjust_char ("<#1D710>", 0.03);
  rsup_adjust_char ("<b-upsilon>", 0.03);
  rsup_adjust_char ("<#1D716>", 0.03);
  rsup_adjust_char ("<b-varepsilon>", 0.03);
  rsup_adjust_char ("<#1D717>", 0.03);
  rsup_adjust_char ("<b-vartheta>", 0.03);
  rsup_adjust_char ("<#1D71B>", 0.02);
  rsup_adjust_char ("<b-varpi>", 0.02);
  rsup_adjust_char ("<alpha>", -0.02);
  rsup_adjust_char ("<b-up-alpha>", -0.02);
  rsup_adjust_char ("<gamma>", 0.02);
  rsup_adjust_char ("<b-up-gamma>", 0.02);
  rsup_adjust_char ("<epsilon>", 0.02);
  rsup_adjust_char ("<b-up-epsilon>", 0.02);
  rsup_adjust_char ("<varepsilon>", 0.02);
  rsup_adjust_char ("<b-up-varepsilon>", 0.02);
  rsup_adjust_char ("<iota>", -0.03);
  rsup_adjust_char ("<b-up-iota>", -0.03);
  rsup_adjust_char ("<lambda>", -0.15);
  rsup_adjust_char ("<b-up-lambda>", -0.5);
  rsup_adjust_char ("<mu>", -0.1);
  rsup_adjust_char ("<b-up-mu>", -0.1);
  rsup_adjust_char ("<chi>", -0.05);
  rsup_adjust_char ("<b-up-chi>", -0.05);
  rsup_adjust_pair ("<cal-C>", -0.01);
  rsup_adjust_pair ("<cal-E>", -0.01);
  rsup_adjust_pair ("<cal-F>", -0.03);
  rsup_adjust_pair ("<cal-G>", -0.02);
  rsup_adjust_pair ("<cal-I>", -0.02);
  rsup_adjust_pair ("<cal-J>", -0.01);
  rsup_adjust_pair ("<cal-S>", -0.01);
  rsup_adjust_pair ("<cal-T>", -0.01);
  rsup_adjust_pair ("<cal-Z>", -0.03);
  rsup_adjust_pair ("<cal-a>", -0.03);
  rsup_adjust_pair ("<cal-d>", -0.01);
  rsup_adjust_pair ("<cal-m>", -0.02);
  rsup_adjust_pair ("<cal-n>", -0.02);
  rsup_adjust_pair ("<cal-o>", -0.01);
  rsup_adjust_pair ("<cal-p>", -0.02);
  rsup_adjust_pair ("<cal-q>", -0.01);
  rsup_adjust_pair ("<cal-u>", -0.02);
  rsup_adjust_pair ("<cal-x>", 0.01);
  rsup_adjust_pair ("<cal-y>", -0.02);
  rsup_adjust_pair ("<bbb-A>", -0.08);
  rsup_adjust_pair ("<bbb-K>", -0.02);
  rsup_adjust_pair ("<bbb-L>", -0.07);
  rsup_adjust_pair ("<bbb-P>", 0.01);
  rsup_adjust_pair ("<bbb-X>", -0.02);
  rsup_adjust_pair ("<frak-A>", -0.04);
  rsup_adjust_pair ("<frak-U>", -0.04);
  rsup_adjust_pair ("<frak-a>", -0.04);
  rsup_adjust_pair ("<frak-i>", -0.03);
  rsup_adjust_pair ("<frak-j>", 0.03);
  rsup_adjust_pair ("<frak-m>", -0.02);
  rsup_adjust_pair ("<frak-n>", -0.02);
  rsup_adjust_pair ("<frak-u>", -0.04);
}

void
unicode_font_rep::script_adjust_bonum () {
  rsub_adjust_pair ("!", 0.05);
  rsub_adjust_pair ("/", -0.05);
  rsub_adjust_pair ("1", -0.02);
  rsub_adjust_pair ("4", 0.02);
  rsub_adjust_pair ("7", -0.08);
  rsub_adjust_pair ("|", 0.05);
  for (char c= 'A'; c <= 'Z'; c++)
    rsub_adjust_pair (string (c), 0.03);
  for (char c= 'a'; c <= 'z'; c++)
    rsub_adjust_pair (string (c), 0.03);
  rsub_adjust_pair ("A", 0.02);
  rsub_adjust_pair ("E", 0.01);
  rsub_adjust_pair ("F", -0.03);
  rsub_adjust_pair ("G", 0.02);
  rsub_adjust_pair ("K", 0.03);
  rsub_adjust_pair ("L", 0.05);
  rsub_adjust_pair ("S", 0.02);
  rsub_adjust_pair ("T", -0.03);
  rsub_adjust_pair ("U", -0.02);
  rsub_adjust_pair ("V", -0.04);
  rsub_adjust_pair ("W", -0.04);
  rsub_adjust_pair ("X", 0.03);
  rsub_adjust_pair ("Y", -0.03);
  rsub_adjust_pair ("Z", 0.05);
  rsub_adjust_pair ("a", 0.05);
  rsub_adjust_pair ("b", 0.02);
  rsub_adjust_pair ("d", 0.05);
  rsub_adjust_pair ("h", 0.05);
  rsub_adjust_pair ("i", 0.05);
  rsub_adjust_pair ("k", 0.05);
  rsub_adjust_pair ("l", 0.08);
  rsub_adjust_pair ("m", 0.05);
  rsub_adjust_pair ("n", 0.05);
  rsub_adjust_pair ("o", 0.03);
  rsub_adjust_pair ("p", 0.02);
  rsub_adjust_pair ("q", 0.02);
  rsub_adjust_pair ("t", 0.05);
  rsub_adjust_pair ("u", 0.05);
  rsub_adjust_pair ("x", 0.05);
  rsub_adjust_pair ("z", 0.02);
  rsub_adjust_pair ("<Gamma>", -0.15);
  rsub_adjust_pair ("<Rho>", -0.08);
  rsub_adjust_pair ("<Tau>", -0.12);
  rsub_adjust_pair ("<Upsilon>", -0.1);
  rsub_adjust_pair ("<Psi>", -0.05);
  rsub_adjust_pair ("<Mho>", -0.03);
  rsub_adjust_char ("<#1D6FC>", -0.02);
  rsub_adjust_char ("<b-alpha>", -0.02);
  rsub_adjust_char ("<#1D6FD>", -0.02);
  rsub_adjust_char ("<b-beta>", -0.02);
  rsub_adjust_char ("<#1D6FE>", -0.03);
  rsub_adjust_char ("<b-gamma>", -0.03);
  rsub_adjust_char ("<#1D701>", -0.05);
  rsub_adjust_char ("<b-zeta>", -0.05);
  rsub_adjust_char ("<#1D703>", -0.02);
  rsub_adjust_char ("<b-theta>", -0.02);
  rsub_adjust_char ("<#1D709>", -0.05);
  rsub_adjust_char ("<b-xi>", -0.05);
  rsub_adjust_char ("<#1D70D>", -0.02);
  rsub_adjust_char ("<b-varsigma>", -0.02);
  rsub_adjust_char ("<#1D70E>", -0.02);
  rsub_adjust_char ("<b-sigma>", -0.02);
  rsub_adjust_char ("<#1D710>", -0.02);
  rsub_adjust_char ("<b-upsilon>", -0.02);
  rsub_adjust_char ("<#1D712>", -0.07);
  rsub_adjust_char ("<b-chi>", -0.07);
  rsub_adjust_char ("<#1D713>", -0.03);
  rsub_adjust_char ("<b-psi>", -0.03);
  rsub_adjust_char ("<#1D717>", -0.02);
  rsub_adjust_char ("<b-vartheta>", -0.02);
  rsub_adjust_char ("<#1D71B>", -0.15);
  rsub_adjust_char ("<b-varpi>", -0.15);
  rsub_adjust_char ("<gamma>", -0.05);
  rsub_adjust_char ("<b-up-gamma>", -0.05);
  rsub_adjust_pair ("<cal-C>", -0.1);
  rsub_adjust_pair ("<cal-F>", -0.15);
  ...
  rsub_adjust_pair ("<cal-Y>", -0.05);
  rsub_adjust_pair ("<cal-d>", -0.08);
  rsub_adjust_pair ("<cal-f>", -0.08);
  rsub_adjust_pair ("<cal-l>", -0.08);
  rsub_adjust_pair ("<cal-y>", -0.03);
  rsub_adjust_pair ("<cal-z>", -0.03);
  rsub_adjust_pair ("<bbb-F>", -0.1);
  rsub_adjust_pair ("<bbb-P>", -0.1);
  rsub_adjust_pair ("<bbb-T>", -0.1);
  rsub_adjust_pair ("<bbb-U>", -0.1);
  rsub_adjust_pair ("<bbb-V>", -0.15);
  rsub_adjust_pair ("<bbb-W>", -0.15);
  rsub_adjust_pair ("<bbb-Y>", -0.12);
  ...
  for (char c= 'A'; c <= 'Z'; c++)
    rsup_adjust_pair (string (c), 0.03);
  for (char c= 'a'; c <= 'z'; c++)
    rsup_adjust_pair (string (c), 0.05);
  rsup_adjust_pair ("B", 0.05);
  rsup_adjust_pair ("C", 0.02);
  rsup_adjust_pair ("D", 0.05);
  rsup_adjust_pair ("E", 0.02);
  rsup_adjust_pair ("F", 0.02);
  rsup_adjust_pair ("G", 0.02);
  rsup_adjust_pair ("I", 0.02);
  rsup_adjust_pair ("K", 0.02);
  rsup_adjust_pair ("L", -0.07);
  rsup_adjust_pair ("O", 0.05);
  rsup_adjust_pair ("R", 0.02);
  rsup_adjust_pair ("S", 0.05);
  rsup_adjust_pair ("T", 0.02);
  rsup_adjust_pair ("U", 0.02);
  rsup_adjust_pair ("V", 0.02);
  rsup_adjust_pair ("W", 0.02);
  rsup_adjust_pair ("X", 0.02);
  rsup_adjust_pair ("Y", 0.02);
  rsup_adjust_pair ("a", -0.03);
  rsup_adjust_pair ("f", 0.02);
  rsup_adjust_pair ("g", 0.02);
  rsup_adjust_pair ("h", -0.03);
  rsup_adjust_pair ("i", 0.02);
  rsup_adjust_pair ("j", 0.04);
  rsup_adjust_pair ("l", 0.03);
  rsup_adjust_pair ("m", -0.03);
  rsup_adjust_pair ("n", -0.04);
  rsup_adjust_pair ("q", 0.02);
  rsup_adjust_pair ("r", 0.02);
  rsup_adjust_pair ("s", 0.02);
  rsup_adjust_pair ("t", 0.02);
  rsup_adjust_pair ("u", -0.03);
  rsup_adjust_pair ("v", 0.02);
  rsup_adjust_pair ("w", 0.02);
  rsup_adjust_pair ("x", 0.02);
  rsup_adjust_pair ("y", 0.02);
  ...
  rsup_adjust_char ("<iota>", -0.03);
  rsup_adjust_char ("<b-up-iota>", -0.03);
  rsup_adjust_char ("<lambda>", -0.07);
  rsup_adjust_char ("<b-up-lambda>", -0.07);
  rsup_adjust_char ("<mu>", -0.03);
  rsup_adjust_char ("<b-up-mu>", -0.03);
  rsup_adjust_char ("<xi>", 0.03);
  rsup_adjust_char ("<b-up-xi>", 0.03);
  rsup_adjust_char ("<varkappa>", -0.05);
  rsup_adjust_char ("<b-up-varkappa>", -0.05);
  rsup_adjust_pair ("<cal-a>", -0.03);
  rsup_adjust_pair ("<cal-d>", -0.03);
  rsup_adjust_pair ("<cal-i>", -0.03);
  rsup_adjust_pair ("<cal-j>", -0.03);
  rsup_adjust_pair ("<cal-k>", 0.03);
  rsup_adjust_pair ("<cal-l>", -0.01);
  rsup_adjust_pair ("<cal-m>", -0.05);
  rsup_adjust_pair ("<cal-n>", -0.05);
  rsup_adjust_pair ("<cal-r>", 0.02);
  rsup_adjust_pair ("<cal-s>", 0.02);
  rsup_adjust_pair ("<cal-u>", -0.03);
  rsup_adjust_pair ("<bbb-A>", -0.05);
  rsup_adjust_pair ("<bbb-B>", 0.02);
  rsup_adjust_pair ("<bbb-D>", 0.02);
  rsup_adjust_pair ("<bbb-K>", -0.05);
  rsup_adjust_pair ("<bbb-L>", -0.1);
  rsup_adjust_pair ("<bbb-O>", 0.02);
  rsup_adjust_pair ("<bbb-R>", -0.05);
  for (char c= 'A'; c <= 'Z'; c++)
    rsup_adjust_pair ("<frak-" * string (c) * ">", 0.02);
  rsup_adjust_pair ("<frak-U>", -0.03);
}
