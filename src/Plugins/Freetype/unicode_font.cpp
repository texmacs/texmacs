...
unicode_font_rep::script_adjust_termes () {
  ...
  rsup_adjust_char ("<lambda>", -0.2);
  rsup_adjust_char ("<b-up-lambda>", -0.2);
  ...
  rsup_adjust_char ("<omega>", -0.05);
  rsup_adjust_char ("<b-up-omega>", -0.05);
  rsup_adjust_char ("<varepsilon>", -0.05);
  rsup_adjust_char ("<b-up-varepsilon>", -0.05);
