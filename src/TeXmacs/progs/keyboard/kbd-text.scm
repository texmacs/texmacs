...
(kbd-map in-text?
  ...
  ("text $" (make-big-expand "equation*") (temp-proof-fix))
  ("text &" (make-expand-arg "eqnarray*") (temp-proof-fix))
  ("text *" (toggle-section-number))

  ("text a" (make-expand-arg "abbr"))
  ("text d" (make-tmlist "description"))
  ("text e" (make-tmlist "enumerate"))
  ("text i" (make-tmlist "itemize"))
  ("text m" (make-expand-arg "em"))
  ("text n" (make-expand-arg "name"))
  ("text p" (make-expand-arg "samp"))
  ("text s" (make-expand-arg "strong"))
  ("text v" (make-expand-arg "verbatim"))
  ("text ;" (make-item))
  ...
  ("F5" (make-expand-arg "em"))
  ("F6" (make-expand-arg "strong"))
  ("F7" (make-expand-arg "verbatim"))
  ("F8" (make-expand-arg "samp"))
  ("S-F6" (make-expand-arg "name"))
  ...
  ("font o" (make-expand-arg "overline"))
  ("font p" (make-with "font shape" "small-caps"))
  ("font u" (make-expand-arg "underline"))
...
")
  ...
  ("copyright var" (make-expand "copyleft"))
  ("guillemotleft" "")
