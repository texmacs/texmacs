...
(menu-bind texmacs-menu
  ...
  (if (test-env? "mode" "text") (=> "Text" (link text-menu)))
  (if (test-env? "mode" "math") (=> "Mathematics" (link mathematics-menu)))
  (if (or (inside? "input") (inside? "output"))
      (=> "Session" (link session-main-menu)))
...
(menu-bind texmacs-main-icons
  ...
  |
  ((balloon (icon "tm_cut.xpm") "Cut text#(C-w)") (clipboard-cut "primary"))
  ((balloon (icon "tm_copy.xpm") "Copy text#(M-w)") (clipboard-copy "primary"))
  ((balloon (icon "tm_paste.xpm") "Paste text#(C-y)") (clipboard-paste "primary"))
...
(menu-bind texmacs-context-icons
  ...
  (if (or (inside? "input") (inside? "output")) (link texmacs-session-icons))
