...
(set-font-rules
  `(((math $ecrm $cmr $cmmi $cmsy $msam $msbm $stmary $wasy $line
    ...
    ((roman trm $a $b $s $d) (math-var ecrm cmr cmmi $s $d))
    ((roman tss $a $b $s $d) (math-var ecss cmss cmmi $s $d))
    ...
    ((concrete trm $a $b $s $d) (math-conc-var eorm ccr xcmmi $s $d))
    ((concrete tss $a $b $s $d) (math-var ecss cmss cmmi $s $d))
