...
;(display "Booting TeXmacs core functionality\n")
(load (url-concretize "$TEXMACS_PATH/progs/core/boot/boot.scm"))
(inherit-modules (core boot compat) (core boot abbrevs) (core boot debug)
		 (core boot srfi) (core boot ahash-table) (core boot prologue))
(inherit-modules (core regexp regexp-match))
(inherit-modules (core drd drd-rules) (core drd drd-query) (core drd drd-data))
(inherit-modules (core texmacs tm-define) (core texmacs tm-preferences)
		 (core texmacs tm-plugins) (core texmacs tm-modes)
		 (core texmacs tm-secure))
(inherit-modules (core library base) (core library list))
(inherit-modules (core gui menu-define) (core gui menu-widget)
		 (core gui kbd-define))
(inherit-modules (core tools tm-edit) (core tools tm-misc)
		 (core tools tm-convert))
