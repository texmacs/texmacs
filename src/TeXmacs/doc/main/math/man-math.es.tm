...
<\body>
  ...
  teclaer símbolos matemáticos y fórmulas. Por ejemplo el prefijo <key|H->
  puede ser usado a fin de ingresar símbolos griegos (recuerdo que <key|H->
  es equivalente a <key|F5>, <key|escape escape escape> o <key|A-C->).
