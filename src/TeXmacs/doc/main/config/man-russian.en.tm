...
<\body>
  ...
  e>>|<cell|<with|language|russian|font|cyrillic|ј>>|<cell|<expand|kbd-text|"
  ...
  A>>|<cell|<with|language|russian|font|cyrillic|Я>>>>>>|Typing Cyrillic text
  on a Roman keyboard.>

  If you want to get, e.g., ``<with|language|russian|font|cyrillic|сх>'', and
  not ``<with|language|russian|font|cyrillic|ш>'', you have to type <key|s /
  ...
  ``<with|language|russian|<with|font|cyrillic|йцукен>''. This input method
  ...
  keys <key|$>, <key|ї>, <key|<with|mode|math|\<backslash\>>>, which are
