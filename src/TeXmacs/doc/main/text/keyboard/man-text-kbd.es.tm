...
<\body>
  <expand|tmdoc-title|Atajos de teclado para el modo texto>
  ...
  >|<cell|<expand|kbd-text|V s>>|<cell|²>>|<row|<cell|<expand|kbd-text|O>>|<cell|Anillo
  superior >|<cell|<expand|kbd-text|O a>>|<cell|å>|<cell|<expand|kbd-text|.>>|<cell|Punto
  superior \n>|<cell|<expand|kbd-text|<group|.>
  z>>|<cell|»>>|<row|<cell|<expand|kbd-text|H>>|<cell|Hungarian
  >|<cell|<expand|kbd-text|H o>>|<cell|®>|<cell|>|<cell|>|<cell|>|<cell|>>>>>|Tecleando
  caracteres acentuados con <TeXmacs>.>

  Los caracteres especiales ÿ, ß,÷,×, æ y Æ son obtenidos, respectivamente,
  tecleando <key|S-F5 s>, <key|S-F5 S>, <key|S-F5 o e>, <key|S-F5 A E>,
  <key|S-F5 a> y <key|S-F5 A>.

  En francés puedes usar también los atajos <key|\<less\> \<less\>> y
  <key|\<gtr\> \<gtr\>> a fin de obtener las <with|font
  shape|italic|guillemets> francesas. En español, el signo de apertura de
  exclamación y el de apertura de interrogación son obtenidos,
...
<\auxiliary>
  <\collection>
    <\associate|table>
      <tuple|normal|Typing accented characters with
