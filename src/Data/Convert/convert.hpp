...
/*** Latex ***/
static array<array<double> > empty_array_of_array_of_double;
tree   parse_latex (string s, bool change= false, bool using_cork= false, bool as_pic= false, bool keep_src= false,  array<array<double> > range= empty_array_of_array_of_double);
