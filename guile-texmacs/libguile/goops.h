...
SCM_API SCM scm_compute_applicable_methods (SCM gf, SCM args, ent len, int scm_find_method);
...
SCM_API SCM scm_i_get_keyword (SCM key, SCM l, ent len, SCM default_value, const char *subr);
